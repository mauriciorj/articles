...
export const FormCreateAccount = ({ ...args }) => {
    ...
    <Grid xs={10} sm={10} md={6} lg={5} xl={5}>
      <Paper elevation={3}>
        ...
        >
          ...
          <Grid xs={10}>
            <form>
              <Box style={{ marginBottom: matches ? '10px' : "0px" }} display="flex" justifyContent="space-between" flexDirection={matches ? 'row' : 'column'}>
              <CssTextField
                error={args.firstNameError}
                helperText={args.firstNameError ? args.firstNameErrorText : null}
                id="firstName"
                label={args.firstNameLabel}
                style={{ width: matches ? '49%' : "100%", marginBottom: matches ? '0' : "10px" }}
                type="text"
                variant="outlined"
              />
              <CssTextField
                error={args.lastNameError}
                helperText={args.lastNameError ? args.lastNameErrorText : null}
                id="lastName"
                label={args.lastNameLabel}
                style={{ width: matches ? '49%' : "100%", marginBottom: matches ? '0' : "10px" }}
                type="text"
                variant="outlined"
              />
